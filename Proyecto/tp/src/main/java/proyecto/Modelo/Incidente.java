...
public class Incidente {
    ...
    public String toString(){
        return "[Id del Técnico: " + this.idTecnico + "\nId del Cliente: " + this.idCliente + "\nDescripción del Incidente: " + this.descripcion + "\nFecha que se ingresó: " + this.fechaIngreso + "\nFecha estimada de resolución: " + this.fechaResolucion + "\nTipo de problema: " + this.tipoProblema + "]";
    }
}
